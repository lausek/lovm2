    ...
    pub fn generate_rust_function(&self) -> impl quote::ToTokens {
        ...
        let code = if self.is_extern {
            quote! {
                #[doc = #docstring]
                #[no_mangle]
                pub extern fn #ident(vm: &mut lovm2_extend::prelude::LV2Vm) -> lovm2_extend::prelude::LV2Result<()> {
                    #body
                }
            }
        } else {
            quote! {
                #[doc = #docstring]
                pub fn #ident(vm: &mut lovm2_extend::prelude::LV2Vm) -> lovm2_extend::prelude::LV2Result<()> {
                    #body
                }
            }
        };
